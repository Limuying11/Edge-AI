...
/* Definitions for Led03 */
osThreadId_t Led03Handle;
const osThreadAttr_t Led03_attributes = {
  .name = "Led03",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  /* creation of Led03 */
  Led03Handle = osThreadNew(LedTask03, NULL, &Led03_attributes);
...
/* USER CODE BEGIN Header_LedTask03 */
/**
* @brief Function implementing the Led03 thread.
* @param argument: Not used
* @retval None
*/
...
void LedTask03(void *argument)
{
  ...
  {
	  HAL_HSEM_FastTake(HSEM_ID_0);
	  if(HAL_GPIO_ReadPin(GPIOI, GPIO_PIN_12) == GPIO_PIN_SET)
		  HAL_GPIO_TogglePin(GPIOI, GPIO_PIN_13);
	HAL_HSEM_Release(HSEM_ID_0, 0);

    osDelay(500);
  }
  /* USER CODE END LedTask03 */
}
